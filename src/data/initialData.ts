...
export const INITIAL_TASKS: CleaningTask[] = [
  {
    ...
    frequency: 'Per-Shift',
    assignedEmployees: ['Ahmad Fauzi', 'Doni Pratama'],
    shift: 'Pagi (06:00 - 14:00)',
    status: 'in_progress',
    priority: 'Tinggi',
    checklist: [
      { id: 'c1', text: 'Dusting meja resepsionis & sofa tunggu', done: true },
      { id: 'c2', text: 'Mopping lantai granit dengan Neutral Cleaner', done: true },
      { id: 'c3', text: 'Pembersihan kaca pintu utama putar (revolving door)', done: false },
      { id: 'c4', text: 'Penggantian plastik standing ashtray luar', done: false }
    ],
    notes: 'Prioritaskan kaca pintu utama sebelum jam buka mall pukul 10:00.',
    updatedAt: '2026-08-25 08:30'
  },
  {
    id: 'tsk-2',
    projectId: 'proj-1',
    areaName: 'Restroom Zona Barat Lt. 1 (Pria & Wanita)',
    frequency: 'Harian',
    assignedEmployees: ['Siti Rahmawati', 'Fitri Handayani'],
    shift: 'Pagi (06:00 - 14:00)',
    status: 'review',
    priority: 'Urgent',
    checklist: [
      { id: 'c5', text: 'Sanitasi kloset duduk & urinoir menggunakan Karbol Pine', done: true },
      { id: 'c6', text: 'Sikat lantai keramik & pembersihan dinding partisi', done: true },
      { id: 'c7', text: 'Refill Hand Soap & Tissue Roll', done: true },
      { id: 'c8', text: 'Keringkan cermin wastafel tanpa noda air', done: true }
    ],
    notes: 'Siap diaudit supervisor. Kaca dan wangi ruangan sudah optimal.',
    updatedAt: '2026-08-25 10:15'
  },
  {
    id: 'tsk-3',
    projectId: 'proj-1',
    areaName: 'Food Court & Dining Area Lt. 2',
    frequency: 'Harian',
    assignedEmployees: ['Ahmad Fauzi', 'Siti Rahmawati'],
    shift: 'Siang (14:00 - 22:00)',
    status: 'todo',
    priority: 'Sedang',
    checklist: [
      { id: 'c9', text: 'Standby sweeping remah makanan di sela meja kursi', done: false },
      { id: 'c10', text: 'Pengosongan tong sampah food court setiap 50% penuh', done: false },
      { id: 'c11', text: 'Damp mopping berkala dengan Caution Sign terpasang', done: false }
    ],
    notes: 'Jaga kebersihan intensif saat peak hour makan siang & makan malam.',
    updatedAt: '2026-08-25 07:00'
  },
  {
    id: 'tsk-4',
    projectId: 'proj-1',
    areaName: 'Taman Depan & Koridor Drop-Off VIP',
    frequency: 'Harian',
    assignedEmployees: ['Eko Prasetyo'],
    shift: 'General (08:00 - 17:00)',
    status: 'done',
    priority: 'Rutin',
    checklist: [
      { id: 'c12', text: 'Penyiraman tanaman hias & rumput gajah mini', done: true },
      { id: 'c13', text: 'Sapu daun kering & pembersihan saluran got kecil', done: true },
      { id: 'c14', text: 'Pemangkasan dahan semak yang menutupi papan petunjuk', done: true }
    ],
    notes: 'Pekerjaan selesai 100%. Laporan foto area disetujui.',
    updatedAt: '2026-08-25 09:45'
  },
  {
    id: 'tsk-5',
    projectId: 'proj-1',
    areaName: 'Basement Parking Area B1 & Lift Lobby',
    frequency: 'Mingguan',
    assignedEmployees: ['Doni Pratama', 'Budi Santoso'],
    shift: 'Malam (22:00 - 06:00)',
    status: 'todo',
    priority: 'Sedang',
    checklist: [
      { id: 'c15', text: 'Scrubbing lantai epoxy lift basement', done: false },
      { id: 'c16', text: 'Pembersihan sarang laba-laba pada pipa ducting AC plafon', done: false },
      { id: 'c17', text: 'Pengurasan bak drainase pompa basement', done: false }
    ],
    notes: 'Jadwal eksekusi malam hari saat kendaraan pengunjung minim.',
